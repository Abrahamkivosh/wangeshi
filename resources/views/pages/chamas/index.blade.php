                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" name="amount" id="amount" class="form-control" placeholder="Chama amount">
                                          </div>
                                          <div class="form-group col-6">
                                            <label for="duration">Chama duration</label>
                                            <input type="text" name="duration" id="duration" class="form-control" placeholder="Chama duration">
                                          </div>
                                          <div class="form-group col-6">
